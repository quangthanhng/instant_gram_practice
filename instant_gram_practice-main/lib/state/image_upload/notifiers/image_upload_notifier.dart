...
import 'package:instagram_clone_qthanh/state/image_upload/constants/constants.dart';
import 'package:instagram_clone_qthanh/state/image_upload/exceptions/could_not_build_thumbnail_exception.dart';
import 'package:instagram_clone_qthanh/state/image_upload/extensions/get_collection_name_from_file_type.dart';
import 'package:instagram_clone_qthanh/state/image_upload/extensions/get_image_data_aspect_ratio.dart';
...
import 'package:instagram_clone_qthanh/state/posts/models/post_payload.dart';
...
class ImageUploadNotifier extends StateNotifier<IsLoading> {
  ...
  Future<bool> upload({
    ...
    // create the references for the thumbnail and the image itself
